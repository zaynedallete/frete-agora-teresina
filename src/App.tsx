      ...
      <section className="py-16 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-5">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col sm:flex-row items-center gap-6 bg-slate-50 border border-slate-200 rounded-2xl px-8 py-7 shadow-sm"
          >
            {/* Google icon */}
            <div className="flex-shrink-0 w-14 h-14 bg-white rounded-xl shadow flex items-center justify-center">
            ...
            <div className="flex-1 text-center sm:text-left">
              <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-1">Google Meu Negócio</p>
              <h3 className="text-lg font-bold text-slate-900 mb-1">Confira nossa página no Google</h3>
              <p className="text-slate-500 text-sm">Veja avaliações de clientes reais e encontre mais informações sobre a Frete Agora.</p>
            </div>

            {/* Button */}
            <a
              href="https://share.google/8H5Ip5c4IjmuIp5Fv"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-shrink-0 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-xl font-semibold text-sm transition-colors shadow-sm whitespace-nowrap"
            >
              Ver no Google
              <ArrowRight className="w-4 h-4" />
            </a>
